...
```
┌─────────────────────────────────────┐ 0x0000
│  JMP main                           │  3 bytes (opcode 0x02 + u16 addr)
├─────────────────────────────────────┤ 0x0003
│  Header                             │  8 bytes
...
|--------|------|-------------|---------------------------------------|
| 0x0000 | 3    | jmp_main    | `JMP <main_addr>` 指令，跳转到 main   |
| 0x0003 | 4    | magic       | ASCII "SAYO" (0x53 0x41 0x59 0x4F)   |
| 0x0007 | 1    | version     | 格式版本号，当前为 0x01               |
| 0x0008 | 2    | text_size   | 代码段大小 (little-endian u16)        |
| 0x000A | 1    | reserved    | 保留字节，填充 0x00                   |

**Total Header Size: 11 bytes (0x000B)**

## Section Details

### .text Section

- 起始地址: `0x000B` (紧跟 header)
...
------  -----                         -----------
0x0000  02 0B 00                      JMP 0x000B (main)
0x0003  53 41 59 4F                   Magic "SAYO"
0x0007  01                            Version 1
0x0008  06 00                         text_size = 6
0x000A  00                            Reserved
0x000B  70 04 12 00 00 00             MOV32 R0, 0x0012 (message addr)
0x0011  55                            RET
0x0012  02 00                         data_count = 2 (u16 LE)
